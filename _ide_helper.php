...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::snowflake($column);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::foreignSnowflake($column);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::foreignSnowflakeFor($model, $column);
        }
